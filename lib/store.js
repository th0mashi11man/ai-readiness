...
/**
 * Custom hook for quiz/survey state with sessionStorage persistence
 * @param {string} storageKey    - sessionStorage key (e.g. 'individual_state')
...
export function useQuizStore(storageKey, items, randomize) {
    ...
    // Init: load from sessionStorage or create new session
    useEffect(() => {
