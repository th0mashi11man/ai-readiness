...
const SHARE_COPY = {
    sv: {
        ...
        formBody: [
            ...
            "Att dela dina svar är frivilligt. Du kan använda verktyget även om du inte vill dela dina svar för forskning. Uppgifterna är anonyma och kopplas inte till dig, vilket innebär att enskilda svar inte kan identifieras eller tas bort i efterhand.",
    ...
    en: {
        ...
        formBody: [
            ...
            "Sharing your answers is voluntary. You can use the tool even if you do not want to share your answers for research. The data is anonymous and is not linked to you, which means individual answers cannot be identified or removed afterwards.",
